...
describe('calculateNumber', () => {
  describe('SUM', () => {
    ...
    it('should return 0 when inputs are -0.4 and 0.4', () => {
      expect(calculateNumber('SUM', -0.4, 0.4)).to.be.equal(0);
    });
  });
  ...
  describe('SUBTRACT', () => {
    ...
    it('should return -0 when inputs are -0.4 and 0.4', () => {
      expect(calculateNumber('SUBTRACT', -0.4, 0.4)).to.be.equal(-0);
    });
  });

  describe('DIVIDE', () => {
    it('should return 0.25 when inputs are 1 and 4', () => {
      expect(calculateNumber('DIVIDE', 1, 4)).to.be.equal(0.25);
    });
  ...
  it('should return 2000000000 when summing 999999999.5 and 999999999.5', () => {
    expect(calculateNumber('SUM', 999999999.5, 999999999.5)).to.be.equal(2000000000);
  });
});
